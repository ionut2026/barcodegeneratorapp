...
describe('BarcodeExportActions', () => {
  ...
  it('renders Copy, Download PNG and Print buttons', () => {
    render(<BarcodeExportActions disabled={false} onDownload={onDownload} onCopy={onCopy} />);
  ...
  it('disables all buttons when disabled=true', () => {
    render(<BarcodeExportActions disabled={true} onDownload={onDownload} onCopy={onCopy} />);
  ...
  it('does not show "Copied" if onCopy throws', async () => {
    ...
    render(<BarcodeExportActions disabled={false} onDownload={onDownload} onCopy={failingCopy} />);
    await act(async () => {
      fireEvent.click(screen.getByText('Copy').closest('button')!);
    });
  ...
  it('renders Print button enabled when not disabled', () => {
    render(<BarcodeExportActions disabled={false} onDownload={onDownload} onCopy={onCopy} />);
